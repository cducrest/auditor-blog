---
title: Olympus DAO update audit result
date: 2023-05-12
description: Results of the Olympus DAO update audit on Sherlock
defer: false
tags:
  - Audit result
  - Audit update
...
This contest was an update following a previous contest on Sherlock in which I also participated.
The code was reviewed as part of the [Sherlock contest](https://app.sherlock.xyz/audits/contests/60).
